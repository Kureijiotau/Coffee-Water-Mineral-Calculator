...
- [Conservative concentrate strength](conservative-aio-strength.md) — apply recipe-specific precipitation-aware recommendations to AIO and each separated stock
...
- [Watermancer transient ion tray](watermancer-sticky-ui.md) — spotlight affected final-ion rows in a timed bottom tray instead of PiP/follow-screen mode
...
- [Magnesium Malate reference basis](magnesium-malate-reference-basis.md) — model reference MgC₄H₄O₅ stoichiometry while keeping malate outside core solver ions
...
- [DIY concentrate persistence scope](diy-concentrate-persistence.md) — DIY Concentrate restoration now comes from the shared autosaved session snapshot
- [DIY concentrate persistence loop](diy-concentrate-persistence-loop.md) — avoid a second DIY plan record; restore the autosaved session once and guard plan writes
