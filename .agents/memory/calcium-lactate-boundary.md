...
**How to apply:** Keep lactate out of `IONS`, `ACTIVE_ION_IDS`, target profiles, and solver inputs. Render it only when the current effective Calcium Lactate dose is positive, using the same effective dose map shown in the Watermancer recipe.