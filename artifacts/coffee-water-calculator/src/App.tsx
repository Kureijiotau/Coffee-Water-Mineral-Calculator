        ...
        (() => {
          ...
          return (
            <div className="fixed inset-0 z-50 flex items-start justify-center p-4 sm:p-6 pt-12 sm:pt-16 overflow-y-auto">
              <div className="fixed inset-0 bg-black/60 backdrop-blur-sm" onClick={() => setShowBrewGuide(false)} />
              <div className="relative w-full max-w-lg bg-slate-800 rounded-2xl shadow-2xl border border-slate-700/60 overflow-hidden">
                <div className="flex items-center justify-between px-5 py-4 bg-gradient-to-r from-emerald-600 to-teal-500">
                  ...
                  <button onClick={() => setShowBrewGuide(false)} className="flex items-center gap-1 text-sm text-white/70 hover:text-white bg-white/10 hover:bg-white/20 rounded-lg px-2.5 py-1.5 transition">
                    <X className="w-4 h-4" />
                  </button>
                </div>
                ...
                <div className="px-5 py-3 bg-slate-900/50 border-t border-slate-700/40 flex items-center justify-between">
                  ...
                  <button onClick={() => setShowBrewGuide(false)} className="text-xs font-medium text-emerald-300 bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/30 rounded-lg px-3 py-1.5 transition">Got it</button>
                </div>
              </div>
            </div>
          );
